...
rem set ACTIVATOR_OPTS=-Djavax.net.ssl.trustStore="%ACTIVATOR_HOME%\conf\cacerts" -Djavax.net.ssl.trustStorePassword="STORE_PASSWORD"
rem echo ACTIVATOR_OPTS=%ACTIVATOR_OPTS%
